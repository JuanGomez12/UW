...
saveFolder = 'ECE613_Images/Fused/Fused_MWT_No_PSO_AVG_';
...
parfor k = 1:length(MRIFiles)
  ...
  %Run the MWT image fusion using the provided coefficients
  [ifpm_k, fused_img] = MWT_no_PSO_AVG(A_RGB, B_RGB, 0.5, 0.5); 
...
save('image_fusion_workspace_MWT_No_PSO_AVG') % Save the whole workspace, just in case
