...
saveFolder = 'ECE613_Images/Fused/FusedDWT_No_PSO_';
...
parfor k = 1:length(MRIFiles)
  ...
  %IFPM
  [ifpm_k, fused_img] = DWT_img_fusion(A_RGB, B_RGB, 0.5, 0.5); 
...
%save('image_fusion_workspace_DWT_No_PSO') % Save the whole workspace, just in case
