function fused_img = dwt_Fusion(img1, img2, w1, w2, w3, w4, w5, w6, w7, w8)
...
%     img2 = cat(3, img2_Red, img2_Green, img2_Blue);
    ...
    LL_F = w1 * LL_img1 + w2 * LL_img2;
    LH_F = w3 * LH_img1 + w4 * LH_img2;
    HL_F = w5 * HL_img1 + w6 * HL_img2;
    HH_F = w7 * HH_img1 + w8 * HH_img2;
