...
A minimum of 108 samples are needed to obtain an effect size of 0.47SD when the significance level is 0.01 and the power is 0.8.
...
# Plot everything
grid.arrange(eng_plot, bio_plot, math_plot, figCaption, layout_matrix = plot_layout, heights = c(0.95, 0.05))
```
